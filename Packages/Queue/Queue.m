...
QueueDrop::usage="Pulls multiple elements off a Queue object";
QueuePop::usage="Pops a single element off a Queue object";


QueuePeek::usage="Looks at the elements on a Queue without modifying it";
...
QueuePeek[q:Queue[data_], n_Integer?Positive:1]:=
  Values@Take[data, UpTo@n];
