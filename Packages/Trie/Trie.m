...
Trie::usage="A Trie";
TrieQ::usage="Tests whether is an actual Trie";
...
TrieRoot::usage="Pulls the common prefix for all words (if exists)";
TrieWords::usage="Pulls the words out of a Trie";
...
attachDefaultWords[assoc_, cur_:""]:=
  AssociationMap[
    With[{cur1=cur<>FromCharacterCode[#[[1]], "UTF8"]},
      #[[1]]->
        If[AssociationQ@#[[2]], 
            Append[attachDefaultWords[#[[2]], cur1], -1->cur1], 
            #[[2]]
            ]
      ]&,
    assoc
...
trieApply//Clear;
trieApply[a_, {char_Integer}]:= (* since single stepping is quite common we'll be efficient about it... *)
  With[{t=a[char]},
    If[AssociationQ[t]||StringQ[t],
      t,
      Missing["KeyAbsent", FromCharacterCode[{char}, "UTF8"]]
      ]
    ];
...
Format[t_Trie?TrieQ, StandardForm]:=
  RawBoxes@
    BoxForm`ArrangeSummaryBox[
      ...
      None,
      {
        BoxForm`MakeSummaryItem[{"Root:", TrieRoot[t]}, StandardForm],
